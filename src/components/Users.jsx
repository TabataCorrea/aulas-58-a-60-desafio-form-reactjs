...
const Users = () => {
    ...
    const usersData = [
        {id: 1, name: 'Tábata', username: 'Tha', email: 'tabata@tabata.com'},
        {id: 2, name: 'Caroline', username: 'Carol', email: 'caroline@caroline.com'},
        {id: 3, name: 'Lilian', username: 'Lih', email: 'lilian@lilian.com'}
    ]
